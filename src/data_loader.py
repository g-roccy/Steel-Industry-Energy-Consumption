...
This module handles loading, cleaning, and preprocessing steel industry energy data.
"""
...
class DataLoader:
    ...
    def inspect_data(self):
        """Display data inspection information"""
        logger.info("\n" + "="*60)
        logger.info("DATA INSPECTION REPORT")
        logger.info("="*60)
        
        logger.info(f"\n📊 SHAPE: {self.data.shape}")
        logger.info(f"   Rows: {self.data.shape[0]}, Columns: {self.data.shape[1]}")
    ...
    def convert_date_column(self, date_col='date'):
    ...
    def save_processed_data(self, output_dir='data/processed', filename='processed_data.csv'):
